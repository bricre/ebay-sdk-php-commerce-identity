# (Unofficial) eBay API client (PHP) - Commerce / Identity
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/commerce/identity/overview.html) for detailed API
...
Starting from version v1.1.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/commerce/identity/v1/',
        'headers'=>[
